...
acf_add_local_field_group( array(
    ...
    'fields'    => array(
        ...
        array(
            'key'           => 'ms_acf_teach_sup_key',
            'label'         => 'Supplementary Slides',
            'name'          => 'ms_acf_teach_sup_name',
            'aria-label'    => '',
            'type'          => 'group',
            ...
            'sub_fields'    => array(
                array(
                    'key'           => 'ms_acf_teach_sup_URL_key',
                    'label'         => 'PDF file',
                    'name'          => 'ms_acf_teach_sup_URL_name',
                    'aria-label'    => '',
                    'type'          => 'file',
                    'instructions'  => '',
                    'required'      => 0,
                ...
                array(
                    'key'           => 'ms_acf_teach_sup_title_key',
                    'label'         => 'Lecture Title',
                    'name'          => 'ms_acf_teach_sup_title_name',
                    'aria-label'    => '',
                    'type'          => 'text',
                    'instructions'  => 'Defaults to "[Post Title] Supplementary Slides"',
                    'required'      => 0,
                    'conditional_logic' => 0,
                    'wrapper'       => array(
                        'width' => '',
                    ...
                    'default_value' => '',
                    'maxlength'     => '',
                    'placeholder'   => 'Unique title for supplementary slides',
                    'prepend'       => '',
                    'append'        => '',
                ),
            ),
